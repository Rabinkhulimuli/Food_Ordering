...
export default function SearchCard({restaurants}:Props){
    
    return(
        <>
            
           { restaurants.map((restaurant)=> (
                <Link key={restaurant._id} to={`/detail/${restaurant._id}`} className=" py-4  shadow-md grid lg:grid-cols-[2fr_3fr] gap-5 group " > 
